                            ...
                            <div class="kt-subheader__main">
                                ...
                                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc" id="kt_subheader_total">
                                     <a href="javascript:;"></i>{{'ITM-'.$data->Item_ID}}-{{$data->id.'-BP'}}</a>
                                    </span>
                                </div>
                            </div>
                                        ...
                                        <div class="kt-widget__content">
                                            <div class="kt-widget__head">
                                                ...
                                                <div class="kt-widget__action">
                                                    <a href="/items" class="btn btn-label-brand btn-sm btn-upper">Back</a>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
                                                            ...
                                                            <ul class="kt-nav">
                                                                ...
                                                                <li class="kt-nav__item">
                                                                    <a href="{{Route('purchaseorder',['id'=>$id])}}" class="kt-nav__link">
                                                                        <i class="kt-nav__link-icon flaticon2-drop"></i>
                                                                        <span class="kt-nav__link-text">Create Purchase Order</span>
                                                                    </a>
                                                                </li>
                                                                <li class="kt-nav__item">
                                                                    <a href="/items/{{$data->id}}/edit" class="kt-nav__link">
                                                                        <i class="kt-nav__link-icon flaticon2-calendar-8"></i>
                                                                        <span class="kt-nav__link-text">Edit Item Details</span>
                                                                    </a>
                                                                </li>
                                                                <li class="kt-nav__item">
                                                                    <a href="/delete/{{$data->id}}" class="kt-nav__link">
                                                                        <i class="kt-nav__link-icon flaticon2-link"></i>
                                                                        <span class="kt-nav__link-text">Delete Item</span>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                            ...
                                            <div class="kt-widget__subhead">
                                                <!-- <a href="javascript:;"></i>{{'ITM-'.$data->item_id}}-{{$data->id.'-BP'}}</a> -->
                                                <a href="javascript:;"></i><b>Estimated Cost : ${{number_format($data->EST_COST,2)}}</b></a>
                                                <a href="javascript:;"></i><b>Purchase Fee : {{number_format($data->Purchase_Fee,2)}}%</b></a>                                            </div>
                                            ...
                                            <div class="kt-section__content">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>MOQ</td>
                                                            <td>{{number_format($data->MOQ)}}/Units</td>
                                                        </tr> 
						    </tbody>
                                                </table>
                                            </div>
                                            ...
                                            <div class="kt-section__content">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>WIDTH</td>
                                                            <td>{{number_format($data->Item_Width,2)}}</td>
                                                            <td>{{number_format(((float)$data->Item_Width)/2.54, 2)}}</td>
                                                            <td></td>
						                                                <td></td>
                                                        </tr>
                                                        <tr>
                                                            <td>LENGTH</td>
                                                            <td>{{number_format($data->Item_Length,2)}}</td>
                                                            <td>{{number_format(((float)$data->Item_Length)/2.54, 2)}}</td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
                                                            <td>HEIGHT</td>
                                                            <td>{{number_format($data->Item_Height,2)}}</td>
                                                            <td>{{number_format(((float)$data->Item_Height)/2.54, 2)}}</td>
                                                            <td></td>
							                                              <td></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td>{{number_format($data->Item_Weight,2)}}</td>
							                                              <td>{{number_format(((float)$data->Item_Weight)/454,6)}}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <div class="kt-portlet__body">
                                            <div class="form-group form-group-xs row">
                                                <div class="col-md-12">
                                                    ...
                                                    <span class="form-control-plaintext kt-font-bolder"><a href="{{$row->filename}}" download>{{$row->filename}}</a></span>
                                                    <hr>
                                                    @endforeach
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="tab-content kt-margin-t-20">
                                            ...
                                            <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                                                <form action="/user/create/item-note" method="post">
                                                   @csrf
                                                    <input type="hidden" name="itemid" value="{{$data->id}}">
                                                    <div class="form-group">
                                                        <textarea class="form-control" id="exampleTextarea" name="comment" rows="3" placeholder="Type notes" required></textarea>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col">
                                                            <button type="submit" class="btn btn-label-brand btn-bold">Add notes</a>
