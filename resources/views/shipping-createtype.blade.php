	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">
										Create Shipping Method Details
									</h3>
								...
								<div class="kt-portlet__body kt-portlet__body--fit">
									<div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_apps_contacts_add" data-ktwizard-state="step-first">
										...
										<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
											...
											<form class="kt-form" action="/create/shipmethod" method="post" enctype="multipart/form-data">
																	...
																	<div class="kt-section__body">
																		...
																		<div class="form-group row">
																			...
																			<div class="col-lg-9 col-xl-9">
																				<input class="form-control" type="text"  id="Cour_name" name="Cour_name" required>
																			</div>
																		</div>
																		<div class="form-group row">
																			<label class="col-xl-3 col-lg-3 col-form-label" for="shippingday">Shipping Time(Days)</label>
																			<div class="col-lg-9 col-xl-9">
                                                                                <input class="form-control" type="number" min=1 step=1  id="shippingday" name="shippingday" required>
																			</div>
																		</div>
                                                                        <div class="form-group row">
       ...
       <script>
			@if(Session::get('msg'))
						swal.fire({
                                "title": "",
                                "text": "The shipping method has been successfully created!",
                                "type": "success",
