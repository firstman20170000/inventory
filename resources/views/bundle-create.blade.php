...
<html lang="en">
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
						...
						<div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
							<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
								<ul class="kt-menu__nav ">
                                    ...
                                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="/bundles" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">BUNDLES</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									...
									<div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white" id="kt_apps_contacts_add" data-ktwizard-state="step-first">
										<div class="kt-grid__item">
											...
											<div class="kt-wizard-v1__nav">
												<div class="kt-wizard-v1__nav-items">
													<a class="kt-wizard-v1__nav-item" href="/bundle/create" data-ktwizard-type="step" data-ktwizard-state="current">
													...
													<a class="kt-wizard-v1__nav-item" href="/bundle/create" data-ktwizard-type="step">
														<div class="kt-wizard-v1__nav-body">
															<div class="kt-wizard-v1__nav-icon">
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--xl">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
											...
											@csrf
																	...
																	<div class="kt-section__body">
																		...
																		<div class="form-group row">
																			...
																			<div class="col-lg-9 col-xl-9">
																				<input class="form-control" type="text" id="Bundle_Name" name="Bundle_Name">
																			</div>
																		</div>
																		<div class="form-group row">
																			<label class="col-xl-3 col-lg-3 col-form-label" for="Bundle_description">BUNDLE DESCRIPTION</label>
																			<div class="col-lg-9 col-xl-9">
																					<textarea class="form-control" id="Bundle_description" rows="3" name="Bundle_description" placeholder=""></textarea>
																			</div>
																		</div>
																		...
																		<div class="row">
																			<div class="col-xl-6">
																				<div class="form-group">
																					...
																					<input type="number"  class="form-control" name="Bundle_turn_time" id="Bundle_turn_time">
																				   <span class="form-text text-muted">Units Per Day</span>
																				</div>
																			</div>
																		...
																		<div class="row">
																			<div class="col-xl-6">
																				<div class="form-group">
																					...
																					<input type="text"  class="form-control" name="Bundle_Model" id="Bundle_Model">
                                                                            ...
                                                                            <div class="col-xl-6">
																				<div class="form-group">
                                                                                    ...
                                                                                    <input type="number" class="form-control" step="0.1" name="Bundle_Fee" id="Bundle_Fee">
												...
												<div class="kt-wizard-v1__content" data-ktwizard-type="step-content">
													<div class="kt-heading kt-heading--md">Bundle Specificiations</div>
																...
																<div class="row">
																	<div class="col-xl-6">
																		<div class="form-group">
                                                                            ...
                                                                            <input type="number" step="0.1" class="form-control" name="Bundle_Width" id="Bundle_Width">
																	...
																	<div class="col-xl-6">
																		<div class="form-group">
                                                                            ...
                                                                            <input type="number" step="0.1" class="form-control" name="Bundle_Height" id="Bundle_Height">
                                                                            <span class="form-text text-muted">Cm</span>
																...
																<div class="row">
																	<div class="col-xl-6">
																		<div class="form-group">
                                                                            ...
                                                                            <input type="number" step="0.1" class="form-control" name="Bundle_Length" id="Bundle_Length">
                                                                            <span class="form-text text-muted">Cm</span>
																	...
																	<div class="col-xl-6">
																		<div class="form-group">
                                                                            ...
                                                                            <input type="number" step="1" class="form-control" name="Bundle_Weight" id="Bundle_Weight">
        ...
        <script src="./assets/js/demo1/pages/custom/contacts/add-bundle.js" type="text/javascript"></script>
