                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        FSO-{{$shipment->Sp_O_id}}-{{$shipment->id}}-BP
                                    </td>
                ...
                <div class="kt-invoice__container">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <?php 
                                $shipment_type=\App\Shippingtype::where('id',$shipment->Shipping_method_type_id)->first();
                                $courier=\App\Shippingmethod::where('id',$shipment->Shipping_method_id)->first();
                            ?>
                            <tbody>
                              <tr>
                                 <td>Shipping Cost</td>
                               
                                 <td>{{$shipment_type->Type_Name}}</td>
