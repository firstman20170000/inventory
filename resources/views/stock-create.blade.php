   ...
   <body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
      ...
      <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
         ...
         <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
            ...
            <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
			   ...
			   <form action="{{Route('user.create.stockorder')}}" method="post">
			   @csrf
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td class="text-center">
                                                ...
                                                <td class="text-center "><div class="col-md-6 col-sm-12" style="margin:auto;padding:1em;">BDL-{{$bundle->bundle_id}}-{{$bundle->id}}-BP</div></td>
                                                <td class="text-center "><div class="col-md-6 col-sm-12" style="margin:auto;padding:1em;"><input class="form-control" type="number" id="bundle_qty" name="bundle_qty" value="{{$min_bundle}}"  step=1 min="0" max="1000000" onchange="onqty(event)" required></div></td>
                                 ...
                                 <div class="kt-section__content">
                                    <table class="table">
                                       <tbody>
                                          <tr>
                                             <td>EST.TAT</td>
                                             <td id="esttot">{{ceil($min_bundle/$bundle->turnaround)}} Days</td>
                                             
                                          </tr>
                                          <tr>
                                             <td>Units in Stock</td>
                                             <td>{{$bundle->bundles_in_stock}}/units</td>
                                          </tr>
                                    ...
                                    <table class="table">
                                       <tbody>
                                          ...
                                          <tr>
					                         ...
					                         <input type="hidden" name="Purchase_fee" value="">
                                          </tr>
                                          <tr>
                                             <td>Grand total</td>
                                             <td id="grandtotal">${{$bundle->bundling_fee*$min_bundle}}</td>
                                          </tr>
                                       </tbody>
                                    </table>
                                 </div>
                     ...
                     <div class="col-md-6">
                        <table class="table">
                           <tbody>
                              <tr>
                                 <td>
                                    <a href="/bundles" class="btn btn-secondary  btn-bold">
                                    cancel
                                    </a>
                                 </td>
                                 <td>
      ...
      <script>
         ...
         function onqty(ev) {
            var ob=ev.target;
            var obval=$(ob).val();
            var total=parseFloat('{{$bundle->bundling_fee}}').toFixed(2)*parseInt(obval)
            var total=total.toFixed(2)
            var tot=Math.ceil(parseInt(obval)/parseInt('{{$bundle->turnaround}}'));
            $('#esttot').html(tot+" Days");
     ...
     ?>
       ...
       ?>
        ...
        ?>
         swal.fire({
                            "title": "",
                            "text": "A new make to stock order have been submitted and Invoice have been created successfully!",
                            "type": "success",
                            "confirmButtonClass": 'btn btn-secondary'
                        }).then(result => {
                           window.location.href = "/view/stock-order/table";
                        })
