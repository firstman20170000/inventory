    ...
    <div class="kt-grid kt-grid--hor kt-grid--root">
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
			...
			<ul class="kt-menu__nav ">
                                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><span class="kt-menu__link-text">Purchase Orders</span><i class="kt-menu__ver-arrow la la-angle-right"></i>
                        ...
                        <div class="kt-container  kt-container--fluid ">
                            <div class="kt-subheader__main">
                                <h3 class="kt-subheader__title">
                                    VIEW PO | PO-{{$data->po_number}}-{{$data->id}}-BP    
                                </h3>
                                ...
                                <div class="kt-widget kt-widget--user-profile-3">
                                    <div class="kt-widget__top">
                                        <div class="kt-widget__media">
                                            <div ><img src="{{asset($data1->Image_Url)}}" alt="image" style="width:30%;"><span style="letter-spacing: 2px;padding:1em;">{{$data1->Item_Name}}</span></div>  
                                        ...
                                        <div class="kt-widget__content">
                                            <div class="kt-widget__head">
                                                ...
                                                <div class="kt-widget__action">
                                                    <a href="{{Route('viewpo')}}" class="btn btn-label-brand btn-sm btn-upper">Back</a>
                                                    <div class="dropdown dropdown-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
                                                            ...
                                                            <ul class="kt-nav">
                                                                ...
                                                                ?>
                                                                <a href="{{Route('editpo',['id'=>$data->id])}}" class="kt-nav__link">
                                                                        <i class="kt-nav__link-icon flaticon2-drop"></i>
                                                                        <span class="kt-nav__link-text">edit Order</span>
                                                                </a>
                                                                <?php                                                                        
                                            ...
                                            <div class="kt-section__content">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>Item#</td>
                                                            <td>ITM-{{$data1->Item_ID}}-{{$data1->id}}-BP</td>
                                                        </tr>
                                                        <tr>
                                                            <td>ORDER QUANTITY</td>
                                                            <td>{{number_format($data->po_qty)}}/Units</td>
                                                        </tr>
                                                        <tr>
                                                            <td>ITEM COST</td>
                                                            <td>${{number_format($data->po_item_cost,2)}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Est. Lead Time</td>
                                                        ...
                                                        <tr>
                                                            <td>DATE CREATED</td>
                                                            <td><?php
                                                                    $origDate=substr($data->created_at,0,10);
                                            ...
                                            <div class="kt-section__content">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>Units TOTAL</td>
                                                            <td>${{number_format($data->po_qty*$data->po_item_cost,2)}}</td>
                                                        ...
                                                        <tr>
                                                            <td>GRAND TOTAL</td>
                                                            <td>${{number_format($data->po_qty*$data->po_item_cost*(100+$data->po_fee)/100,2)}}</td>
                                                            
                                                        </tr>
                                                        <tr>
                                                            <td>INVOICE</td>
                                                            <td><?php
                                                               $invoice=\App\Invoice::where('order_id',$data->po_number)->where('type','po')->first();
                                                            ?>
                                                            <?php 
                                                              if($invoice)
                                                              {
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="tab-content kt-margin-t-20">
                                            ...
                                            <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                                                <form action="{{Route('user.postnote')}}" method="post">
                                                @csrf 
                                                <input type="hidden" name="poid" value="{{$data->po_number}}">
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="subnote" id="exampleTextarea" rows="3" placeholder="Type notes"></textarea>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col">
