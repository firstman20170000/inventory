                ...
                <div class="kt-invoice__container">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>PO-{{$Item->po_number}}-{{$Item->id}}</td>
                ...
                <div class="kt-invoice__container">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>{{$cogood->Item_Name}}</td>
                                    <td>{{number_format($Item->po_qty)}}</td>
                                    <td>${{number_format($Item->po_item_cost, 2, '.', '')}}</td>
                                    <td></td>
                                    <td  style="color:black">{{number_format($Item->po_qty*$Item->po_item_cost,2)}}</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td>{{number_format($Item->po_fee,2)}}%</td>
                                    <td   style="color:black" >${{number_format($Item->po_item_cost*$Item->po_qty* $Item->po_fee/100, 2, '.', '')}}</td>
                                </tr>    
