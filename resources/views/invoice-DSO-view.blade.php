...
<!-- end:: Subheader -->
    ...
    <div class="kt-portlet__body kt-portlet__body--fit">
        <div class="kt-invoice-1">
            <div class="kt-invoice__head" style="color:black;">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        DSO-{{$shipment->dropship_number}}-{{$shipment->id}}-BP
                                    </td>
                ...
                <div class="kt-invoice__container">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <?php 
                                $shipment_type=\App\Shippingtype::where('id',$shipment->shipping_method_type)->first();
                                $courier=\App\Shippingmethod::where('id',$shipment->shipping_method)->first();
                            ?>
                            <tbody>
                              <tr>
                                 <td  style="color:black">Shipping Cost</td>
                               
                                 <td  style="color:black">{{$shipment_type->Type_Name}}</td>
                                 <td  style="color:black">{{$courier->Courier_Name}}</td>
                                 <td  style="color:black">${{number_format($invoice->Invoice_total, 2, '.', '')}}</td>
