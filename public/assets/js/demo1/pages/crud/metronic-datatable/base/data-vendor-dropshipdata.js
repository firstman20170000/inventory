            ...
            success: function (data) {
                ...
                var datatable = $('.kt-datatable').KTDatatable({
                    ...
                    columns: [{
                        ...
                        {
                            field:'dropship_number',
                            title:'DSO#',
                            textAlign: 'center',
                            template:function(pu_data)
                            {

                                var output = "DSO-"+pu_data.dropship_number+"-"+pu_data.id+"-BP";
                        ...
                        {
                            field:'dropship_reference',
                            title:'Reference',
                            textAlign:'center',
                            template:function(pu_data)
                            {
                                var output=pu_data.dropship_reference;
                                return output;
                            }
                        ...
                        },
                        {
                            ...
                            textAlign: 'center',
                            template:function(pu_data) {
                               var output=pu_data.tracking_number;
                                return output;
                            }
                        },
                       
                        {
                            field: 'drop_shipping_cost',
                            title: 'Order total',
                            textAlign: 'center',
                           
                            template:function(pu_data)
                            {
                                if(pu_data.drop_shipping_cost!=null)
                                {
                                    var stock="$"+formatNumber(pu_data.drop_shipping_cost);
                                    return stock;
                                }
                        ...
                        },
                        {
                            ...
                            template: function (data) {
                                ...
                                var output = '\
                                    <a href="/view/dropship/' + id + '" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit details">\
                        ...
                        },
                        {
                            ...
                            template: function (data) {
                                ...
                                if(status_id==5||status_id==6)
                                {
                                    ...
                                    var output = '\
                                    <a href="/edit/dropship/' + id + '" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit details">\
                                        <i class="la la-edit"></i>\
                                    </a>';    
                                } 
